...
- the selected neck accessory is missing without a physically plausible pose-based occlusion, both accessories appear, a substitute accessory appears, or the accessory choice tracks the shot scale instead of the per-job random choice; a naturally hidden pendant in a genuine side/back view is allowed when no scarf or substitute is present;
